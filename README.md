## THIS IS THE REWRITE BRANCH!!!! YOU WILL WANT TO CHECK OUT THE [BETA BRANCH](https://github.com/VanillaEngineDevs/Vanilla-Engine/tree/betav) WHILE THIS GETS FINISHED
